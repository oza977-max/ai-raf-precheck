...
//
// R15-C1 renegotiation: the role-switcher label changed from "Role" to
// "Viewing as" (proposal §3.8 honesty copy) — the /role/i selector below is
// updated to /viewing as/i to match, same lookup intent.
describe('App — 1LoD nav surface (R12-AD-2)', () => {
  ...
  it('TC-R12-AD-2-03: switching from 2LoD to 1LoD while on the rule-queue view falls back to intake', async () => {
    ...
    await user.selectOptions(screen.getByLabelText(/viewing as/i), '1LoD');
